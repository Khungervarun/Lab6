	...
	<header>
		...
		<nav>
			...
			<ul>
				...
				<li><a href="green.php" title="Green Page">Green Blocks</a></li>
	...
	<main>
		...
		<aside>
			...
			<blockquote cite="https://www.brainyquote.com/quotes/fred_rogers_193081">
				<p>Play is often talked about as if it were a relief from serious learning. But for children, play is <em>serious learning</em>. Play is really the work of childhood. –Fred Rogers</p>
			</blockquote>
			<p>Take a little time every day to just play with technology – you’ll be <strong>surprised</strong> how much you learn.</p>
		</aside>
	</main>
	<!-- Page-level footer -->
	<footer>
		...
		<nav>
			...
			<li><a href="about/privacy-policy.php" title="Read our Privacy Policy">Privacy Policy</a> | <a href="about/privacy-policy.php#personal-information" title="Learn about how we treat your personal information">Use of Personal Information</a>
			<li>
